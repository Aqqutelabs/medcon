...
<section class="section">
    <div class="container intro-grid">
        <div><span class="eyebrow">Who we are</span><h2>A trusted medical education admissions partner</h2><a class="about-accreditation-link" href="<?= e(site_url('accreditation')) ?>">See Accreditation <span aria-hidden="true">→</span></a></div>
        <div>
