    ...
    <footer class="site-footer">
        <div class="container footer-grid">
            <div>
                ...
                <p>supports students and families with structured international medical education admissions guidance.</p> Medcon Educational Services and Consultancy Limited
            </div>
            <div>
