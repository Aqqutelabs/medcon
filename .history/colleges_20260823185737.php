...
?>
<section class="section featured-colleges"><div class="container"><div class="featured-heading"><span class="partner-pill">Our partner institutions</span><h2>Partner Medical Colleges</h2><p>Admission, visa, travel and student settlement support provided by .</p></div><div class="featured-college-grid"><?php foreach ($collegeData as $college) { render_college_card($college); } ?></div></div></section> Medcon Educational Services and Consultancy Limited
