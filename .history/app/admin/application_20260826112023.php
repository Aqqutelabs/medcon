...
<body class="medcon-app mc-role-body"><header class="mc-role-topbar"><a href="<?= esc(app_url('admin/dashboard.php')) ?>" class="mc-portal-logo"><img src="<?= esc(site_url('img/logo.svg')) ?>" alt="Medcon"><span>Admin portal</span></a><nav class="mc-admin-nav" aria-label="Admin portal"><a href="<?= esc(app_url('admin/dashboard.php')) ?>" aria-current="page">Applications</a><a href="<?= esc(app_url('admin/leads.php')) ?>">Eligibility leads</a></nav><div class="mc-portal-user"><span><?= esc($user['full_name']) ?></span><a href="<?= esc(app_url('logout.php')) ?>">Sign out</a></div></header>
