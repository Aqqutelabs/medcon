...
function crafted_by_aqqute(): void {
    echo '<footer class="mc-portal-footer"><span>&copy; ' . date('Y') . ' Medcon Educational Services and Consultancy Limited</span><span>Crafted by <a href="https://aqqute.com" target="_blank" rel="noopener noreferrer">Aqqute</a></span></footer>';
}
