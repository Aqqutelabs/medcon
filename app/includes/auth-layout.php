<?php
// Load Cloudflare protection early
...
function auth_page_end(bool $showFooter = true): void { ?>
        </div>
        <?php if ($showFooter): ?><footer class="mc-auth-footer"><span>&copy; <?= date('Y') ?> Medcon Educational Services and Consultancy Limited</span><span>Crafted by <a href="https://aqqute.com" target="_blank" rel="noopener noreferrer">Aqqute</a></span></footer><?php endif; ?>
    </section>
</main>
