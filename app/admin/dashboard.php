...
<?php admin_portal_header($user, 'applications'); ?>
<main class="mc-role-main">
    ...
    <section class="mc-panel"><h2>Website analytics</h2><p><a class="mc-arrow-link" href="<?= esc(app_url('admin/calculator.php')) ?>">View visitors, button clicks and fee calculator activity &rarr;</a></p></section>
