...
handle_inquiry_submission('homepage');
...
?>
        ...
        <section class="section soft" id="study">
            <div class="container">
                <div class="admissions-slider" data-admissions-slider>
                    ...
                    <div class="admissions-progress" aria-hidden="true"><span></span></div>
                    ...
                    <div class="process-cta persistent-eligibility-cta">
                        <a class="btn btn-primary" href="<?= e(site_url('eligibility-checker.php')) ?>">Check Eligibility</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="section featured-colleges" id="colleges">
            <div class="container">
                <div class="featured-heading">
                    ...
                    <p>Admission, visa, travel and student settlement support provided by Medcon Educational Services and Consultancy Limited.</p>
                </div>
                        ...
                        <article class="featured-college-card">
                            ...
                            <div class="featured-college-body">
                                ...
                                <dl class="college-stats">
                                    <div>
                                        <dt><?= e($college['tuitionLabel']) ?></dt>
                                        <dd><?= htmlspecialchars($college['tuition']) ?></dd>
                                    </div>
                                    <div>
                                        <dt><?= e($college['durationLabel']) ?></dt>
                                        <dd><?= htmlspecialchars($college['duration']) ?></dd>
                                    </div>
                                    <div>
                                        <dt><?= e($college['intakeLabel']) ?></dt>
                                ...
                                <div class="college-actions">
                                    <a class="btn btn-outline college-button" href="college-<?= e($college['slug']) ?>.php">View College</a>
        ...
        <section class="advice-zone">
            <div class="advice-grid">
                <img src="img/parents-index.png" alt="Students receiving medical education support">
        ...
        <section class="section" id="parents">
            <div class="container split">
                <div>
                    ...
                    <a class="btn btn-primary" href="<?= e(MEDCON_CONSULTATION_URL) ?>" target="_blank" rel="noopener noreferrer">Book a Parent Consultation</a>
                </div>
        ...
        <section class="section" id="apply">
            <div class="container split">
                <div class="apply-enquiry-intro">
                    ...
                    <figure class="apply-enquiry-image">
                        <img src="<?= e(site_url('img/apply-img.png')) ?>" alt="Prospective medical student completing an application form beside a laptop">
                    </figure>
                </div>
                <?php render_inquiry_form($collegeData); ?>
            </div>
        </section>
